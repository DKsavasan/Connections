// components/GroupedHistoryItems.tsx
...
interface GroupedHistoryItemsProps {
  contacts: contact[];
}

const GroupedHistoryItems: React.FC<GroupedHistoryItemsProps> = ({
  contacts,
}) => {
...
export default GroupedHistoryItems;
